...
- **pre-commit:** Gate the commit message on vale's attribution rule ([36e5bcc](https://github.com/ZacKienzle2/Orderbooks/commit/36e5bcccdd7267554cf662356189fbf59a42ff61))

- **profiling:** Cachegrind plugin and on-demand workflow ([9e413da](https://github.com/ZacKienzle2/Orderbooks/commit/9e413da82c76cc66eca822564b2efbe34a678a0a))

- **engine:** Publish a reject event on arena exhaustion ([6d5f726](https://github.com/ZacKienzle2/Orderbooks/commit/6d5f726ef955508ceee3747ea772fb761d5ae0cb))

- **engine:** Honour ClOrdID chaining on cancel-replace ([dbb49ea](https://github.com/ZacKienzle2/Orderbooks/commit/dbb49ea91d80fc883d342d004250327d4c37219b))
...
- **config:** Sync vale's styles whenever the hooks run ([afda7c1](https://github.com/ZacKienzle2/Orderbooks/commit/afda7c17593e7f50d420772b39c96c3100746519))

- **config:** Update from the shared template ([ae9410f](https://github.com/ZacKienzle2/Orderbooks/commit/ae9410f20d28421b369e18d23baa73bf0cd4930d))

- **config:** Update from the shared template ([9523956](https://github.com/ZacKienzle2/Orderbooks/commit/95239561c73344996ee4d521f13cc3fcb73da413))

- **config:** Update from the shared template ([0caf4f9](https://github.com/ZacKienzle2/Orderbooks/commit/0caf4f9668b2ae5051814322f1d46a9991b12d47))

- **config:** Update from the shared template ([7884cc1](https://github.com/ZacKienzle2/Orderbooks/commit/7884cc127fa4aeee2e906a167d015bef6b23263d))

- **config:** Update from the shared template ([bee8e67](https://github.com/ZacKienzle2/Orderbooks/commit/bee8e6729fe36d368aec9d3035864c84cd07272c))

- **config:** Take the lint configuration from the shared template ([342e69f](https://github.com/ZacKienzle2/Orderbooks/commit/342e69f0dde6674d78e5b6b4b6f333aaada126d4))
...
- **workflows:** Pin every action to a digest with its exact tag ([f72c81e](https://github.com/ZacKienzle2/Orderbooks/commit/f72c81eeb4df5bad1882593519496b45ea5f301f))

- **cmake:** Run clang-tidy through cpp-linter and drop the format job ([3c9e894](https://github.com/ZacKienzle2/Orderbooks/commit/3c9e894afdf380821a96743c249609190f114abc))

- **release:** Create the release with the runner's gh ([92cf356](https://github.com/ZacKienzle2/Orderbooks/commit/92cf3568099cc4633bc3147f00d3da3730f36beb))

- **workflows:** Take the published all-green gate ([306ea23](https://github.com/ZacKienzle2/Orderbooks/commit/306ea2368959226cfa0bf108795950616ab20335))

- **workflows:** Run the repository's hooks instead of copies of them ([b6b5804](https://github.com/ZacKienzle2/Orderbooks/commit/b6b580446d81392dec84b95f8037773fa8c9c960))

- **security:** One scanner per concern, and scans that run when private ([e4e209c](https://github.com/ZacKienzle2/Orderbooks/commit/e4e209c184ee70eeab31fee15b32545cd81f2d1d))

- **commitlint:** Drop the rules the package already sets ([345b0d7](https://github.com/ZacKienzle2/Orderbooks/commit/345b0d7beddc94e4e26bf9984e531e1d99c8c13d))

- **workflows:** Run checks on pull requests and drop the scheduled sweep (#76) ([12969b0](https://github.com/ZacKienzle2/Orderbooks/commit/12969b06d443a4489f4e8aaece4edeaccc55c99b))
...
- **shfmt:** Apply shfmt across the tree ([14f5a3f](https://github.com/ZacKienzle2/Orderbooks/commit/14f5a3f24c32ccc18ce05921ec6262fe5b67e58a))

- **prettier:** Apply prettier across markdown, yaml and json ([4eded40](https://github.com/ZacKienzle2/Orderbooks/commit/4eded4020d67a75d7971e48a3320a89dfc7e129a))

- **cmake:** Format at the width the hook now applies to every file ([54e7511](https://github.com/ZacKienzle2/Orderbooks/commit/54e7511b9f2f61f72bf727770b69ccf1faf5fb3a))

- **lob:** Prune dead clock_source concept and duplicate hash ([9cccfe6](https://github.com/ZacKienzle2/Orderbooks/commit/9cccfe65b06d37b27687a3ddb73b5e7fe16cafba))

- **lob:** Align mirrored precheck identifiers and name the digit buffer ([6cd3ca3](https://github.com/ZacKienzle2/Orderbooks/commit/6cd3ca34201dde915d25c3ae15f0d4d00f9979d2))

- **config:** Drop unused tick_size [**breaking**] ([09dc153](https://github.com/ZacKienzle2/Orderbooks/commit/09dc153503b82b9f5596f74215688aaf03782252))
...
- **adr:** Say at no cost where proselint reads a cliche ([fa912bb](https://github.com/ZacKienzle2/Orderbooks/commit/fa912bb96c2953efee95300114a6f1e956b15b2e))

- **adr:** Record the reject event, seq partitioning, and ClOrdID chain ([9b383da](https://github.com/ZacKienzle2/Orderbooks/commit/9b383da5c1e94632fd2535dffc2d749ce365eb84))

- **dev:** Refresh the gateway and threading guides ([d20bd8c](https://github.com/ZacKienzle2/Orderbooks/commit/d20bd8c2821f829537cc455e329d33ee4564a414))

- **engine:** Record that a qty-only modify keeps time priority ([b1340ce](https://github.com/ZacKienzle2/Orderbooks/commit/b1340ce26245ca1a4b47b331c1434e3fbd8a262b))

- **runtime:** State the join fail-fast contract on noexcept stop ([acc7b68](https://github.com/ZacKienzle2/Orderbooks/commit/acc7b680a3b6cc25feca4fa9005f4400d4f46942))
...
- **pre-commit:** Give cmakelang its width through a file every batch reads ([9a96084](https://github.com/ZacKienzle2/Orderbooks/commit/9a96084432e4f0ab56704c6367a5fb18d7b892cf))

- **workflows:** Run zizmor through the action its project publishes ([9548c9b](https://github.com/ZacKienzle2/Orderbooks/commit/9548c9b4193d6bba7e93eee03a18f5aa4c3949ab))

- **profiling:** Guard cg_annotate against pipefail on truncation ([08b8ce4](https://github.com/ZacKienzle2/Orderbooks/commit/08b8ce4ac9657c28bb7e7cfa80e282cba7499114))

- **profiling:** Never pass /usr/include through -isystem ([c87f2eb](https://github.com/ZacKienzle2/Orderbooks/commit/c87f2ebd5a897454b92f67947b859f91b1aeb0e9))

- **ci:** Compile the cachegrind binary with g++ ([2e12116](https://github.com/ZacKienzle2/Orderbooks/commit/2e121162ec53b4563407d8eafec0d11f7d033749))

- **bench:** Drop useless casts rejected by ci gcc ([270f066](https://github.com/ZacKienzle2/Orderbooks/commit/270f066d592023746c198e9400d217bddb40aaf2))

- **bench:** Measure what the engine benches claim to measure ([06c694f](https://github.com/ZacKienzle2/Orderbooks/commit/06c694f227ba9075948552d304c725c78a2e0d65))

- **histogram:** Honour the configured cap below the resolution floor ([7f9bf2b](https://github.com/ZacKienzle2/Orderbooks/commit/7f9bf2b5694252f97cbf5b74b2d92b923e5f73bf))

- **gateway:** Reject the reserved order ids at every trust boundary ([620d07e](https://github.com/ZacKienzle2/Orderbooks/commit/620d07e746bc4e1f78c57d8dffa57f82cbc9e0ea))

- **gateway:** Ack killed for an IOC or FOK that executes nothing ([250fe3c](https://github.com/ZacKienzle2/Orderbooks/commit/250fe3cab8c9f4b7243a4fc23bf9399d6c39712d))

- **gateway:** Clamp the pipeline window and validate the listen port ([e3aa6a6](https://github.com/ZacKienzle2/Orderbooks/commit/e3aa6a695f27e077b224ea0978011803967a2169))

- **merger:** Clamp zero batch_max and coalesce the merged tally store ([36fec45](https://github.com/ZacKienzle2/Orderbooks/commit/36fec456b3cabb5ed989c6eb46701aedece6e17b))

- **runtime:** Seed disjoint seq ranges per shard ([a94ee03](https://github.com/ZacKienzle2/Orderbooks/commit/a94ee039ceeb9ba76b0b14c270b8128b24cba777))

- **gateway:** Enforce max_order_qty on submit, modify and restore ([dd2c9ae](https://github.com/ZacKienzle2/Orderbooks/commit/dd2c9ae8aae0c4274e5980794e438dc62b9ea1ce))

- **fix:** Bound BodyLength so a stream caller can resynchronise ([d9aee21](https://github.com/ZacKienzle2/Orderbooks/commit/d9aee2166d04bbb8de83868cdb5fcdd931e980ec))

- **histogram:** Count clamped samples and surface overflow in apps ([a63c24f](https://github.com/ZacKienzle2/Orderbooks/commit/a63c24f2ad02765e3b7bcbaf49e33d6e9a22e27e))

- **replay:** Validate self-cross and accounts arguments ([ff68e79](https://github.com/ZacKienzle2/Orderbooks/commit/ff68e7978788c299efbfea69addbf48bca958989))

- **engine:** Validate snapshot bytes before enum casts on restore ([dd47a15](https://github.com/ZacKienzle2/Orderbooks/commit/dd47a15a3f36ac951a3d1d63deadc01d0045b112))

- **merger:** Bound per-shard drain to stop head-of-line blocking ([c080991](https://github.com/ZacKienzle2/Orderbooks/commit/c080991c3927d33b2620b10b8925573f0d9d1e94))

- **engine:** Make FOK precheck account-aware under self-cross ([c3b0280](https://github.com/ZacKienzle2/Orderbooks/commit/c3b0280bbf102573b1f937f5c984449cfe35f725))

- **gateway:** Validate wire orders before engine dispatch ([7e8faf6](https://github.com/ZacKienzle2/Orderbooks/commit/7e8faf6de49780772b2ff27afb430a8f93c08f45))
...
- **lob:** Cache best-of-book and drop redundant level_idx ([7f1199c](https://github.com/ZacKienzle2/Orderbooks/commit/7f1199c22a88683fa7c44f5700bec34050586121))

- **gateway:** Batch socket reads and ack writes per recv ([e878397](https://github.com/ZacKienzle2/Orderbooks/commit/e8783970b88003bf8de53a96ab04008ca5d9478e))
...
- **bench:** Cover the id_index and the FOK precheck walk ([1f30094](https://github.com/ZacKienzle2/Orderbooks/commit/1f30094742ad80d3144322b98922dec32df684ec))

- **messages:** Cover the reject kind across the event seam ([84aa13b](https://github.com/ZacKienzle2/Orderbooks/commit/84aa13b312c7b38d827ca6214ec0023c2da4d97f))

- **engine:** Close FOK all-or-nothing gap in differential and invariant suites ([a288570](https://github.com/ZacKienzle2/Orderbooks/commit/a288570e0c6a411363eb1f8ee58a549249861956))
